          ...
          <div className="flex flex-col md:flex-row gap-10 items-center relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-slate-600 italic leading-relaxed mb-6">
                &quot;Oricare was created with a simple vision — no elderly person should feel alone when their children are away chasing dreams. We step in to provide the care, warmth, and reliability of family.&quot;
              </p>
              
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-bold text-slate-900 text-lg">Jane Doe</p>
                  <p className="text-teal-600 font-medium text-sm">Founder & CEO, Oricare</p>
                </div>
